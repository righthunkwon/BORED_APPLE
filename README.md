...
| ----------- | ------------- | ----------------------------------------------------- | ---------------------------------------- | ----------- | ---------------------------- |
| BE <br>학습서버,<br>오늘의학습<br>스케쥴링     | BE/Infra<br>CI,CD<br>문장유사도<br>MMR<br>유저서버 | FE <br>소셜로그인/회원가입, <br> 랜딩페이지, <br> 오늘의학습, <br>간이테스트 | FE <br> 소개페이지, <br>, 어휘퀴즈<br> 마이페이지<br>-학습일지 | BE <br> 소셜 회원가입<br>소셜로그인<br>게임 서버 | FE <br>어휘퀴즈, <br>마이페이지<br>-분석보고서 |
